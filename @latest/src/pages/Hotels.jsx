...
import hotelbanner from "../assets/banner/banner-5.webp";
...
const resorts = [
  {
    image:
      "https://shreethemes.net/geotrip-live/geotrip/assets/img/hotel/hotel-8.jpg",
    name: "Value Hotel Balestier",
    location: "Delhi | 3.5 Km From Delhi",
    policy: "Free Cancellation Till 10 Aug 23",
    facility:
      "✔️Cooling,  ✔️Pet Allow,  ✔️Free Wifi  ✔️Food Parking  ✔️Spa & Massage",
    discount: "15% Off",
    price: "US$59",
    days: "per night",
    rating: "3,014 reviews",
  },
  {
    image:
      "https://shreethemes.net/geotrip-live/geotrip/assets/img/hotel/hotel-5.jpg",
    name: "Mercue Singapore Tyrwhitt ",
    location: "Delhi | 3.5 Km From Delhi",
    policy: "Free Cancellation Till 10 Aug 23",
    facility:
      "✔️Cooling,  ✔️Pet Allow,  ✔️Free Wifi  ✔️Food Parking  ✔️Spa & Massage",
  ...
  {
    image:
      "https://shreethemes.net/geotrip-live/geotrip/assets/img/hotel/hotel-4.jpg",
  ...
  {
    image:
      "https://shreethemes.net/geotrip-live/geotrip/assets/img/hotel/hotel-3.jpg",
  ...
  {
    image:
      "https://shreethemes.net/geotrip-live/geotrip/assets/img/hotel/hotel-2.jpg",
...
const Hotels = () => {
  ...
  return (
    <div className="w-full min-h-[100vh] pt-16">
                ...
                <div class="col-span-1">
                  <div class="grid grid-cols-2 gap-3">
                    ...
                    <div class="flex items-end">
                      <button
                        type="button"
                        class="w-full bg-blue-500 text-white py-4 rounded-md"
                      >
      ...
      <div className="mt-16 mx-7 lg:mx-0">
        ...
        <div className=" px-0 lg:px-14">
          ...
          <Slider {...settings}>
            {resorts?.map((i, index) => (
              <div
                className="w-full rounded-md shadow-md shadow-slate-200 my-3 mx-auto lg:w-[600px]  lg:mx-0 overflow-hidden"
                key={index}
              >
                ...
                <div className="w-full p-3 h-64 bg-[#FFFFFF]">
                  ...
                  <button className="text-xs bg-[#D4EEE3] py-1 px-4 text-green-600 font-semibold mt-7">
                    {i.policy}
                  </button>
                  <p
                    className="text-sm text-gray-500 leading-7 text-wrap whitespace-nowrap font-semibold"
                  ...
                  <div className="flex justify-between mt-8 items-center">
                    <div>
                      <button className="px-3 py-1 text-xs font-semibold bg-green-800 text-white rounded">
                        {i.discount}
                      </button>
                      <p className="text-2xl text-nowrap whitespace-nowrap text-black font-bold">
                        {i.price}
                      </p>
                    </div>
                    ...
                    <div className="flex flex-center gap-2">
                      ...
                      <button className="text-sm text-nowrap whitespace-nowrap text-white font-semibold bg-red-600 px-2 py-1 rounded">
                        4.8
                      </button>
                    </div>
                  </div>
        ...
        <div className=" px-0 lg:px-14">
          ...
          <Slider {...settingss}>
            {destination?.map((i, index) => (
              <div
                className="w-full h-[65vh] border-2 border-dashed  rounded-lg shadow-md shadow-slate-200 my-3 mx-auto lg:w-[600px]  lg:mx-5 overflow-hidden"
                key={index}
              >
                ...
                <div className="w-full text-center">
                  <h3 className="text-2xl text-black font-bold">{i.title}</h3>
                  <p
        ...
        <div className=" px-0 lg:px-14">
          ...
          <Slider {...settings3}>
            {domestic?.map((i, index) => (
              <div
                className=" mx-auto border-2 border-dashed shadow-md shadow-slate-200	 my-3 lg:mx-auto rounded-lg   overflow-hidden"
                key={index}
              >
                ...
                <div className="w-full p-3 h-36 bg-[#FFFFFF]">
                  ...
                  <p className="text-lg text-nowrap whitespace-nowrap text-black font-bold lg:ml-44 mt-5 ml-40">
      ...
      <div className="mt-16 mx-7 lg:mx-0">
        <div className="flex justify-between items-center px-1 lg:px-12">
          <h1 className="text-sm lg:text-base font-bold text-nowrap">
            Featured Rental In Australia
          </h1>
          <button className="text-sm text-white font-semibold bg-[#384BFF] rounded py-3 px-7">
        ...
        <div className=" mx-auto gap-2 lg:gap-0 lg:mx-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
          {rental?.map((i, index) => (
            <div
              className=" shadow-md shadow-slate-200	my-3 mx-auto rounded-md overflow-hidden  overflow-hidden"
              key={index}
            >
